...
[^7]: Essentially following [Veale & Borgesius, Demystifying the Draft EU Artificial Intelligence Act](https://arxiv.org/abs/2107.03721).
...
[^8]: Essentially following [Veale & Borgesius, Demystifying the Draft EU Artificial Intelligence Act](https://arxiv.org/abs/2107.03721).
...
[^9]: Essentially following [Veale & Borgesius, Demystifying the Draft EU Artificial Intelligence Act](https://arxiv.org/abs/2107.03721).
...
... in *number of defined applications, products and sectors*.
...
[^10]: Essentially following [Veale & Borgesius, Demystifying the Draft EU Artificial Intelligence Act](https://arxiv.org/abs/2107.03721).

-   ::: {style="font-size: 80%;"}
    -   Can add sub-areas within these areas, if similar risk to an existing in-scope application, but cannot add new areas entirely.
...
[^11]: See [Stark & Hoey, The Ethics of Emotion in Artificial Intelligence Systems](https://dl.acm.org/doi/10.1145/3442188.3445939).

-   Provider vs. user boundary not that sharp; each alone may lack information
-   Emotion recognition is anything but limited-risk.
    -   [Scientific models of emotion are under-complex, and data reflect this]{style="font-size: 80%;"}

    -   [Emotions, and their expression, are inseparable from social, cultural, situational context]{style="font-size: 80%;"}

    -   [Emotions are intimately related to human dignity]{style="font-size: 80%;"}

    -   [Emotions are often subject to moral judgement]{style="font-size: 80%;"}

    -   [In consequence, social credit effects arise]{style="font-size: 80%;"}

## Problems: General

-   Risk-based laudable insofar it takes context into account; however in practice, models/applications are ported to different contexts. This invalidates the original assessment.

-   Does not reflect important ways AI is being used, for example: No covering of AIaaS (https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3824736)
